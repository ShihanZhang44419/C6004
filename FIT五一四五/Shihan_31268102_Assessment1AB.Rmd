...
a) In Northen Territoty, region Apatula's population overtabkes region Katherine in 2021.
   ...
   * Plese click on the image link, if image not pop up.
...
b) Overall, the decline in the total population will reduce the percentage of children. Observed by year, the percentage of children in previous years will affect the population of the next year, so a declining percentage of children will reduce the total population of the next year.
   ![Image of All path](https://ibb.co/HBxBY82)
...
# summarise the median value by state
summarise(q4box,
          'ACT_median' = median(immunisation_rate[which(State == 'ACT')]),
          'NSW_median' = median(immunisation_rate[which(State == 'NSW')]),
          'QLD_median' = median(immunisation_rate[which(State == 'QLD')]),
          'SA_median' = median(immunisation_rate[which(State == 'SA')]),
          'WA_median' = median(immunisation_rate[which(State == 'WA')]),
          'TAS_median' = median(immunisation_rate[which(State == 'TAS')]),
          'VIC_median' = median(immunisation_rate[which(State == 'VIC')]),
          'VIC/NSW_median' = median(immunisation_rate[which(State == 'VIC/NSW')]))
```
