...
def cal_stock_revenue(data_dict):
    ...
    input_year = data_dict['start_year']
    ...
    if input_day > 0:
        ...
        # initialise the running year list
        running_year = []
        ...
        monthly_revenue_list.pop()
        defective_return_list.pop()
        defective_revenue_list.pop()
        cut_profit_list.pop()
    ...
    final_info = {"end_year": default_year - 1,
                  "end_stock": end_year_stock,
                  "end_revenue": end_year_revenue}
